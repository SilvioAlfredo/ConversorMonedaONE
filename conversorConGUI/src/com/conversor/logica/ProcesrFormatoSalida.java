...
public class ProcesrFormatoSalida {
	...
	EscuchadorEntrada escuchadorEntrada = new EscuchadorEntrada();
	
	
	
	public void validarEntradaYSalida( int entrada, int salida) {
		System.out.println(entrada + " " + salida);
		System.out.println("Introduzca un valor para cconvertir!");
		
		Scanner teclado = new Scanner (System.in);
		double entradaMonto = teclado.nextDouble();
		if (entrada == 1 && salida == 2 || entrada == 1 && salida == 3 
				|| entrada == 1 && salida == 4 || entrada == 1 && salida == 5 || entrada == 6 && salida == 6) {
			...
			if(valorEntrada > 0.0) {
				...
				}else if(entrada == 1 && salida == 6) {
					convertirDolar.dolarAPesoArgentino(valorEntrada);
				}
			}
		}else if(entrada == 2 && salida == 1 || entrada == 2 && salida == 3 
				|| entrada == 2 && salida == 4 || entrada == 2 && salida == 5 || entrada == 2 && salida == 6) {
			double valorEntrada = entradaMonto;
			if(valorEntrada > 0.0) {
				//Esta parte está terminada
				...
				}else if(entrada == 2 && salida == 6) {
					convertirEuro.euroAPesoArgentino(valorEntrada);
				}
			}
		}else if(entrada == 3 && salida == 1 || entrada == 3 && salida == 2 
				|| entrada == 3 && salida == 4 || entrada == 3 && salida == 5 ||entrada == 3 && salida == 6) {
			double valorEntrada = entradaMonto;
			if(valorEntrada > 0.0) {
				//Esta parte está terminada
				...
				|| entrada == 4 && salida == 5 ||entrada == 4 && salida == 6) {
			double valorEntrada = entradaMonto;
			if(valorEntrada > 0.0) {
				//Esta parte está terminada
				...
				|| entrada == 5 && salida == 4 || entrada == 5 && salida == 6) {
			double valorEntrada = entradaMonto;
			if(valorEntrada > 0.0) {
